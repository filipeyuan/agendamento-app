...
- [x] **Fase 6**: Referência visual e mobile. Pesquisar SaaS reais de agendamento/produtividade (paleta de cores, estrutura de home, estilo de componentes) e aplicar o que fizer sentido pro Zelo parecer um produto maduro, não um projeto de estudo. Inclui: ~~badges com mais cor~~, ~~ícone de cadeado em horário indisponível~~, ~~ícone de "+" pra adicionar horário~~, e ~~otimização do modo mobile~~
