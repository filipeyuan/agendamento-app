    ...
    <table role="presentation" width="100%" style="max-width:480px; margin:0 auto; background:#ffffff; border-radius:12px; overflow:hidden;">
        ...
        <tr>
            <td style="padding:28px;">
                <h1 style="margin:0 0 16px; font-size:20px; color:#111827;">Agendamento remarcado</h1>
                <p style="margin:0 0 12px; font-size:15px; color:#374151; line-height:1.5;">
                    Seu agendamento de <strong>{{ $appointment->service->name }}</strong> foi remarcado.
                </p>
                <p style="margin:0; font-size:15px; color:#374151; line-height:1.5;">
                    Novo horário: <strong>{{ $when }}</strong>
                </p>
            </td>
        </tr>
    </table>
