        ...
        <tr>
            <td style="padding:28px;">
                ...
                <p style="margin:0 0 12px; font-size:15px; color:#374151; line-height:1.5;">
                    Recebemos o pagamento dos seus <strong>{{ $count }} agendamentos recorrentes</strong> de <strong>{{ $serviceName }}</strong>.
                </p>
                <p style="margin:0 0 12px; font-size:15px; color:#374151; line-height:1.5;">
                    Primeiro horário: <strong>{{ $firstWhen }}</strong>
                </p>
                <p style="margin:0; font-size:14px; color:#6b7280; line-height:1.5;">
                    Assim que o estabelecimento confirmar cada agendamento, você recebe um e-mail.
                </p>
            </td>
        </tr>
    </table>
